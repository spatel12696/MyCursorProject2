...
import { getUpcomingBookings, deleteBooking } from '../utils/bookings'
...
export default function UpcomingBookings() {
  ...
  useEffect(() => {
    // Load bookings whenever the component mounts or location changes
    loadBookings()
  }, [location])
            ...
            <div className="space-y-4">
              {bookings.length === 0 ? (
                <div className="text-center py-8 text-gray-600 font-bold text-xl">
                  No upcoming bookings. Click the + button to create one!
                </div>
              ) : (
